...
public class ZXingCodeUtils {
	 ...
	 * @throws IOException
	 */
	private static BufferedImage appendLogoOrTitle(BufferedImage image, String title, Integer fontSize, InputStream logoImage) throws IOException {
		try {
			...
			if (title != null && !"".equals(title)) {
				...
				BufferedImage outImage = new BufferedImage(image.getWidth(), image.getHeight() + titleHeight, BufferedImage.TYPE_INT_RGB);
